...
public class Point {
    ...
    public Point(int x, int y) {// two arg constructor
    ...
    public void setX(int x) {// method 3
        this.x =  x;
    }

    public void setY(int y) {// method 4
        this.y = y;
    }
    ...
    public double distance(int x, int y) {// method 6
        return Math.sqrt((x - this.x) * (x - this.x) + (y - this.y) * (y - this.y));

         }
         public double distance(Point second){//method 7
